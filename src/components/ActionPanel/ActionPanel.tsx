...
export const ActionPanel: FC<IProps> = ({
    ...
    return <div className={'App-ActionPanel__wrapper'}>
        <div className={'App-ActionPanel__container'}>
        ...
        <div className={'App-common__button'} style={{margin: '0 auto'}} onClick={goResults}>
